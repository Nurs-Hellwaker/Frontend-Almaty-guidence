...
const MOCK_TOURS: Tour[] = [
  {
    ...
    country: 'Казахстан',
    city: 'Алматы',
    description: 'Это путешествие к одному из самых величественных мест в окрестностях города. Озеро расположилось в глубокой впадине на высоте более 2500 метров. Окруженное сосновым лесом и тремя величественными пиками (Советов, Озерный и Турист), БАО поражает своим цветом, который меняется от молочно-голубого до изумрудного в зависимости от времени года.',
    price: '12500.00',
    duration: 1,
    image: null,
    available_slots: 18,
